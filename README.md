# PROJEK PORTFOLIO Evita Maharani
...
1. **Clone repositori ini:**
   ...
   ```bash
   git clone https://github.com/elvitamhraniii24-pixel
   cd Evita-portofolio
   ```
...
Proyek ini adalah karya asli milik **Evita Maharani** dan hanya diperbolehkan untuk digunakan sebagai referensi pribadi.
